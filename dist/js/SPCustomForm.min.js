  ...
  $.fn.formify = function(options) {
    ...
    var processFieldData = function() {
      ...
      if (settings.includeControls) {
        var paperclipImg = settings.scriptFolder + "img/paperclip.png";
    ...
    var getAttachments = function() {
      ...
      var html = "";
      var deleteImg = settings.scriptFolder + "img/delete.png";
          ...
          .done(function(data) {
            ...
            if (isExit) {
              ...
              var html = "<div><a target='_blank' href='#'>" + file.name + "</a>" +
                "<span class='deleteAttachment'  style='margin-left:10px;' data-file='" + file.name + "'><img src='" + settings.scriptFolder + "img/delete.png'></span></div>";
              that.find(".attachments").append(html);
...
//get the fieldValue for Edit form
    ...
    var getAllData = function() {
      ...
      */
      ...
      var modalUrl = settings.scriptFolder + "html/modal.html";
      var deferreds = [];
